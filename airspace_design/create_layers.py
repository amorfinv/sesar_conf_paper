...
def main():
    ...
    layers_1_range, flight_dict = build_layer_airspace_dict(25, 75, 25, ['C', 'T', 'F'], ['C', 'T', 'F'], 'range')
    layers_1_levels, _ = build_layer_airspace_dict(25, 75, 25, ['C', 'T', 'F'], ['C', 'T', 'F'], 'levels')

    layers_2_range, _ = build_layer_airspace_dict(25, 75, 25, ['F', 'T', 'C'], ['C', 'T', 'F'], 'range')
    layers_2_levels, _ = build_layer_airspace_dict(25, 75, 25, ['F', 'T', 'C'], ['C', 'T', 'F'], 'levels')

    # create layers dictionary
    layers_1 = {'range': layers_1_range, 'levels': layers_1_levels, 'starting_cruise_layer': flight_dict['levels'][0]}
    layers_2 = {'range': layers_2_range, 'levels': layers_2_levels, 'starting_cruise_layer': flight_dict['levels'][2]}
